	...
	<div class="container">
				<div class="row">
					<div class="col-md-8">
						...
						<form action="login.php" class="form-light mt-20" method="get" role="form">
						...
						<div class="form-group">
							...
							<button type="submit" name="submit" value="sbmit" class="btn btn-two">submit</button>
						<p>
						already amember?<li><a href="login.php">login</a></li>signin</a>
                       </p>						
